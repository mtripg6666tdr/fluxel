...
import type { ChildrenType, StateParam, ReactiveDependencyUse, MemoizeFunction } from "../type";
...
const Fluxel = BaseFluxel as typeof BaseFluxel & {
  ...
  component: <P extends object, S extends object, R extends ChildrenType>(
...
Fluxel.component = function <P extends object, S extends object, R extends ChildrenType>(
  renderer: (props: P, state: StateParam<S>) => R,
  initialState?: S | ((props: P) => S),
) {
